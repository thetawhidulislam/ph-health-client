    ...
    const tableColumns : ColumnDef<TData>[] = actions ? [...columns,
        ...
        // Action column
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <DropdownMenu>
                        <DropdownMenuTrigger className="h-8 w-8 p-0 text-muted-foreground hover:bg-muted focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none rounded-md">
